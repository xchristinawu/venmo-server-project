...
//    @Test
//    public void findAllOtherUsers_returns_all_users_except_current_user() {
//        String currentUser = "1001";
//        List<User> users = sut.listAllOtherUsers(currentUser);
//
//        Assert.assertNotNull(users);
//        Assert.assertEquals(2, users.size());
//        //Assert.assertEquals(USER_1, users.get(0));
//        Assert.assertEquals(USER_2.getId(), users.get(0).getId());
//        Assert.assertEquals(USER_2.getUsername(), users.get(0).getUsername());
//
//        Assert.assertEquals(USER_3.getId(), users.get(1).getId());
//        Assert.assertEquals(USER_3.getUsername(), users.get(1).getUsername());
//    }
